...
import com.sharpen.core.*;
import com.sharpen.core.io.IO;
...
public class SharpenCommandLineTestCase  {
	...
	public void testMethodMappings() {
		...
		assertEquals(new Configuration.MemberMapping("Foo.baz", com.sharpen.core.MemberKind.Method), cmdLine.memberMappings.get("Foo.bar"));
	}
	...
	public void testResponseFile() throws Exception {
		...
		assertEquals("foo", cmdLine.project);
		assertEquals(1, cmdLine.memberMappings.size());
		assertEquals(new Configuration.MemberMapping("Foo.bar", com.sharpen.core.MemberKind.Method), cmdLine.memberMappings.get("Foo.foo"));
